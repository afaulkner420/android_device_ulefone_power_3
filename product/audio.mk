...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/media/media_codecs.xml:system/etc/media_codecs_mediatek_audio.xml \
    $(DEVICE_PATH)/configs/media/media_codecs.xml:system/etc/media_codecs_mediatek_video.xml
# Codecs
PRODUCT_COPY_FILES += \
